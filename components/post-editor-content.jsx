...
import { Icon, ImageIcon, Minus, Plug, Plus, Sparkles } from "lucide-react";
                        ...
                        <div>
                            {!hasContent? <>
                                  ...
                                  <div className="grid grid-cols-3 w-full gap-2">
                                    {[
                                        {type:"enhance",icon:Sparkles,color:"green",className:"border-green-500 text-green-400 hover:bg-green-500 hover:text-white"},
                                        {type:"expand",icon:Plus,color:"blue",className:"border-blue-500 text-blue-400 hover:bg-blue-500 hover:text-white"},
                                        {type:"simplify",icon:Minus,color:"orange",className:"border-orange-500 text-orange-400 hover:bg-orange-500 hover:text-white"},
                                    ].map(({type,icon:Icon,color,className})=>{
                                        return <Button
                                         key={type}
                            ...
                            {!hasTitle && (
                                ...
                                Add a title to enable AI content generation </p>
                            )}
