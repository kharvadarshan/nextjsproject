...
const PostEditor = ({initialData=null, mode="create"})=>{
    ...
    const router = useRouter();
     ...
     const { mutate:createPost, isLoading: isCreateLoading } = useConvexMutation(api.posts.createPost);

     const { mutate: updatePost, isLoading: isUpdating }= useConvexMutation(api.posts.updatePost)
